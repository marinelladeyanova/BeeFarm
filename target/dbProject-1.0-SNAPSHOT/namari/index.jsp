...
<div id="wrapper">
    ...
    <header id="banner" class="scrollto clearfix" data-enllax-ratio=".5">
            ...
            <div class="row clearfix">
                <div class="col-1">
                    ...
                    <div id="logo">
                        ...
                        <img src="images/logo-5.jpg" id="banner-logo" alt="Landing Page" height="600" />
                        <!--End of Banner Logo-->

                        <!--The Logo that is shown on the sticky Navigation Bar-->
                        <img src="images/logo-5.png" id="navigation-logo" alt="Landing Page"/>
        ...
        <!--Banner Content-->
        <%@ include file="include-files/banner.jspf"%><!--End of Row-->
    </header>

    <!--Main Content Area-->
    <main id="content">

        <%@ include file="include-files/content-introduction.jspf" %>
